...
import io.github.mikegirkin.ardeas.Model.{Api, Default, HttpOperation, Parameter, PathSegment, Response, ResponseBody, Schema}
...
import io.github.mikegirkin.ardeas.scala.ScalaSpecifics.TypeNaming
